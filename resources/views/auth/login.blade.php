      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                  <button class="btn btn-block g-login">
                    <img class="mr-3" src="{{ asset('sa/images/file-icons/icon-google.svg') }}" alt="">Log in with Google</button>
                </div>
            ...
            <p class="footer-text text-center">copyright © 2019 RentalMobilStudio. All rights reserved.</p>
          </div>
        </div>
      </div>
